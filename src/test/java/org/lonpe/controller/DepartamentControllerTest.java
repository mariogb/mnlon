...
@MicronautTest
public class DepartamentControllerTest extends AbstractControllerTest<Departament> {
    ...
    public void testT() throws Exception {
        ...
        System.out.println("----testT -- Inicia login para probar DepartamentController");
        ...
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/departament/t").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
    ...
    departament.setPkey("X_"+ff);
    
    
        departament.setDescription("description"+ff);
            
        departament.setFastKey("fastKey"+ff);
    ...
    public void testModel() throws Exception {
        ...
        System.out.println("\n\n\t **** Inicia login para probar Model en DepartamentControllerController");
        final String accessToken = doLogin0(embeddedServer);        
        final Rx3HttpClient client0 = createHttpClient(embeddedServer.getURL());
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/departament/model").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
        HttpResponse<Map> exchange = client0.toBlocking().exchange(bearerAuth, Map.class);
    ...
    public void testList() throws Exception {
        ...
        System.out.println("Inicia login para probar LIST en DepartamentControllerController");
