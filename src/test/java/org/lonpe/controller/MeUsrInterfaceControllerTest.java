...
@MicronautTest
public class MeUsrInterfaceControllerTest extends AbstractControllerTest<MeUsrInterface> {
    ...
    public void testT() throws Exception {
        ...
        System.out.println("----testT -- Inicia login para probar MeUsrInterfaceController");
        ...
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/meUsrInterface/t").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
    ...
    meUsrInterface.setPkey("X_"+ff);
    
    
        meUsrInterface.setDc("dc"+ff);
            
        meUsrInterface.setLabel("label"+ff);
    ...
    public void testModel() throws Exception {
        ...
        System.out.println("\n\n\t **** Inicia login para probar Model en MeUsrInterfaceControllerController");
        final String accessToken = doLogin0(embeddedServer);        
        final Rx3HttpClient client0 = createHttpClient(embeddedServer.getURL());
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/meUsrInterface/model").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
        HttpResponse<Map> exchange = client0.toBlocking().exchange(bearerAuth, Map.class);
    ...
    public void testList() throws Exception {
        ...
        System.out.println("Inicia login para probar LIST en MeUsrInterfaceControllerController");
