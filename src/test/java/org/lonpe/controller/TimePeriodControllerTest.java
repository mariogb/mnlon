...
@MicronautTest
public class TimePeriodControllerTest extends AbstractControllerTest<TimePeriod> {
    ...
    public void testT() throws Exception {
        ...
        System.out.println("----testT -- Inicia login para probar TimePeriodController");
        ...
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/timePeriod/t").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
    ...
    timePeriod.setPkey("X_"+ff);
    
    
        timePeriod.setPname("pname"+ff);
    ...
    public void testModel() throws Exception {
        ...
        System.out.println("\n\n\t **** Inicia login para probar Model en TimePeriodControllerController");
        final String accessToken = doLogin0(embeddedServer);        
        final Rx3HttpClient client0 = createHttpClient(embeddedServer.getURL());
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/timePeriod/model").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
        HttpResponse<Map> exchange = client0.toBlocking().exchange(bearerAuth, Map.class);
    ...
    public void testList() throws Exception {
        ...
        System.out.println("Inicia login para probar LIST en TimePeriodControllerController");
