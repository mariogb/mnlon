...
@MicronautTest
public class ProductTypeControllerTest extends AbstractControllerTest<ProductType> {
    ...
    public void testT() throws Exception {
        ...
        System.out.println("----testT -- Inicia login para probar ProductTypeController");
        ...
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/productType/t").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
    ...
    productType.setPkey("X_"+ff);
    
    
                productType.setAfectStock(true);
                    
        productType.setDescription("description"+ff);
            
        productType.setFastKey("fastKey"+ff);
            
                productType.setIsService(true);
                    
        productType.setPname("pname"+ff);
            
                productType.setTaxable(true);
    ...
    public void testModel() throws Exception {
        ...
        System.out.println("\n\n\t **** Inicia login para probar Model en ProductTypeControllerController");
        final String accessToken = doLogin0(embeddedServer);        
        final Rx3HttpClient client0 = createHttpClient(embeddedServer.getURL());
        final MutableHttpRequest<Object> bearerAuth = HttpRequest.GET("/pg/productType/model").bearerAuth(accessToken).accept(MediaType.APPLICATION_JSON);
        HttpResponse<Map> exchange = client0.toBlocking().exchange(bearerAuth, Map.class);
    ...
    public void testList() throws Exception {
        ...
        System.out.println("Inicia login para probar LIST en ProductTypeControllerController");
