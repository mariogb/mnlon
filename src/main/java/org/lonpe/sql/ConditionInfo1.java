...
public class ConditionInfo1 {
    ...
    public ConditionInfo1(LinkedHashSet<String> condiciones, Integer numParam, Integer max, Integer offset, String orden, boolean withCount) {
