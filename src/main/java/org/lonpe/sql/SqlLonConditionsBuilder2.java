 ...
 * @author mgb
 */
public final class SqlLonConditionsBuilder2 {

    private final HttpParameters params;
    private final Tuple tuple;
    final LinkedHashSet<String> condiciones = new LinkedHashSet<>();
    private Integer numParam = 1;
    String orden = "id";

    public SqlLonConditionsBuilder2(HttpParameters params, Tuple tuple) {
        this.params = params;
        this.tuple = tuple;
