...
public class DCMainService {
    ...
    public Single<LinkedHashMap> listModels(final Long userLon_id) {
        ...
        final LinkedHashMap respuesta = new LinkedHashMap();
        respuesta.put("m_dcmodel", lsModel);
    ...
    private void init0() {
        lsModel = new LinkedHashMap<>();
            ...
            setIn(applicationContext.getBean(PurchaseContractServiceLon.class));
            
            setIn(applicationContext.getBean(SaleContractServiceLon.class));
            
            setIn(applicationContext.getBean(SaleTypeServiceLon.class));
            
            setIn(applicationContext.getBean(PurchaseTypeServiceLon.class));
            ...
            setIn(applicationContext.getBean(PurchaseServiceLon.class));
            
            setIn(applicationContext.getBean(SaleServiceLon.class));
            ...
            setIn(applicationContext.getBean(AlumnoServiceLon.class));
            
            setIn(applicationContext.getBean(MateriaServiceLon.class));
            
            setIn(applicationContext.getBean(CalificacionServiceLon.class));
