...
//PC
        dcm.setPc("pname");   
    dcm.addSProperty(pname);             //Create property sku   
...
//sku -------------------------------------------
    names.add("sku");
    insertMapFields.put("product.sku","sku");  // productType --------------------
...
private static final String SQLINSERT = "INSERT INTO product(pkey,description,fast_key,pname,sku,product_type_id,id) VALUES ($1,$2,$3,$4,$5,$6,(select nextval('seq_product'))) returning id,pkey";
...
public Single<Map<String, Object>>  save(Product product) {
    ...
    public Single<Map<String,Object>> doList(final ObjForQuery objForQuery) {
        return doList000(crudLon, "product", objForQuery);
