...
//ON RELATION departamentJob    
    final SOtm departamentJobInstances = new SOtm("departamentJobInstances","departamentJobInstance","departamentJob");                    
...
public Single<Map<String, Object>>  save(DepartamentJob departamentJob) {
    ...
    public Single<Map<String,Object>> doList(final ObjForQuery objForQuery) {
        return doList000("departament_job", objForQuery);
