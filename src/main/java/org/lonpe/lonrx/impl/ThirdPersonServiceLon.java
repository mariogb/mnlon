...
//ON RELATION thirdPerson    
    final SOtm purchaseContracts = new SOtm("purchaseContracts","purchaseContract","thirdPerson");                    
    dcm.addSOtm(purchaseContracts); 
//ON RELATION thirdPerson    
    final SOtm saleContracts = new SOtm("saleContracts","saleContract","thirdPerson");                    
    dcm.addSOtm(saleContracts); 
//ON RELATION thirdPerson    
    final SOtm userThirdPersons = new SOtm("userThirdPersons","userThirdPerson","thirdPerson");                    
...
public Single<Map<String, Object>>  save(ThirdPerson thirdPerson) {
    ...
    public Single<Map<String,Object>> doList(final ObjForQuery objForQuery) {
        return doList000("third_person", objForQuery);
...
// withIndex true
    slcb.doIlPSimple2( "tipo", "third_person_tipo");
