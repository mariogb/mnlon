...
//ON RELATION workSpace    
    ...
    dcm.addSOtm(stockRack); 
        //
            final SOtm stockRackProducts = new SOtm("stockRackProducts","stockRackProduct","stockRack"); 
            dcm.addSOtm2(stockRackProducts);
            
        //;
        
        //
            final SOtm InvoiceLineIns = new SOtm("InvoiceLineIns","invoiceLineIn","stockRackProduct"); 
            dcm.addSOtm3(InvoiceLineIns);            

            final SOtm InvoiceLineOuts = new SOtm("InvoiceLineOuts","invoiceLineOut","stockRackProduct"); 
            dcm.addSOtm3(InvoiceLineOuts);            
        //
...
public Single<Map<String, Object>>  save(WorkSpace workSpace) {
    ...
    public Single<Map<String,Object>> doList(final ObjForQuery objForQuery) {
        return doList000("work_space", objForQuery);
